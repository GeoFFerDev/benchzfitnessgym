...
<head>
    ...
    <style>
        body {
            ...
            background:
                radial-gradient(circle at top left, rgba(190, 24, 93, 0.22), transparent 24%),
...
<body class="min-h-screen text-slate-100">
    <div class="grid min-h-screen lg:grid-cols-[1.1fr_0.9fr]">
        <section class="relative hidden overflow-hidden lg:flex">
            ...
            <div class="absolute -left-12 top-10 h-60 w-60 rounded-full bg-rose-500/20 blur-3xl"></div>
            <div class="absolute bottom-8 right-8 h-72 w-72 rounded-full bg-amber-400/10 blur-3xl"></div>
        ...
        <section class="flex items-center justify-center px-4 py-8 sm:px-6 lg:px-10">
            <div class="w-full max-w-xl">
                <div class="mb-8 lg:hidden">
                    <p class="text-xs uppercase tracking-[0.4em] text-rose-200/80">Bench-Z Fitness</p>
                ...
                <div class="glass-panel rounded-[2rem] p-6 sm:p-8">
                    <div class="flex items-start justify-between gap-4">
                        <div>
                            <p class="text-xs uppercase tracking-[0.35em] text-rose-200/80">Member Access</p>
                            <h2 class="mt-3 text-3xl font-extrabold text-white">Sign In</h2>
                            <p class="mt-3 text-sm leading-6 text-slate-300">
                                Use your account credentials to open the dashboard.
                            </p>
                        </div>
                        <div class="rounded-2xl bg-rose-500/10 px-3 py-2 text-xs font-semibold text-rose-100">
                            Secure login
                        </div>
                    </div>
                    ...
                    <div class="mt-8 flex flex-col gap-4 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
                        <p class="text-sm text-slate-400">
                            New here? <a href="{{ route('register') }}" class="font-semibold text-white hover:text-rose-200">Create an account</a>
                        </p>
                        <p class="text-xs uppercase tracking-[0.28em] text-slate-500">Bench-Z Portal</p>
                    </div>
                </div>
            </div>
        </section>
